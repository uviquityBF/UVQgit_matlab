...
%% read data
    ...
    S = load_comsol_sweep_cube([PathName,FileName], 'n_eff', 'c2:ff50');   %no more than 50 modes
...
%% pull out the parameter values (also stacked to 3D Cube on Parameter2 by the loader)
    P1s = S.P1s;
    P2s = S.P2s;
    P1s_u = S.P1_u;    Nvals1 = S.Nvals1;    %Wavelength values
    P2s_u = S.P2_u;    Nvals2 = S.Nvals2;    %number of param1 values
    Nm = S.Nm;                                                     %number of modes
    B = S.cube;
