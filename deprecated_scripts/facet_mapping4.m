%% Waveguide Chip Automated Alignment Tool (GSheet-Synchronized Version)
clc; clear; close all;
...
%% 7. Mathematical Matrix Alignment (Independent Translation Tracking)
...
if num_measured == 1
    ...
    % Synchronized Translation Calibration (Matching GSheet Step 6 Logic)
...
% Apply the true calculated physical tilt to both facets independently
