...
%% get data
    ...
    filepath = 'G:\Shared drives\Corp Main\Engineering\LAB EXPERIMENTS\2024_10_21_LabData\2024_10_24_Uvq-sd7_LWGwh655id22.4_SHG_Sweep_spectra';
...
% Loop Over Files
    for kf=1:Nf
        ...
        %analyze peak
        iBG  = find(BG_range(1) <= WL & WL<= BG_range(2) );
        
        BGlevel = mean(Y(iBG));
        iPK  = find(peak_search_Range(1) <= WL & ...
                    WL <= peak_search_Range(2) & ...
                    Y > BGlevel*1.5 );
